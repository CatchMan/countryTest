...
import com.example.catchman.counrytz.ui.LoadingDialog
import com.example.catchman.counrytz.ui.LoadingView
import com.example.catchman.counrytz.di.component.ActivityComponent
import com.example.catchman.counrytz.di.component.DaggerActivityComponent
...
abstract class BaseActivity : AppCompatActivity(), IView, BaseFragment.Callback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        activityComponent = DaggerActivityComponent.builder()
                ...
                .applicationComponent((application as CountryApp).appComponent)
                .build()
